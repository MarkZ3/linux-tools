...
/**
 * An abstract operation containing common code useful for
 * other trace package operations
 *
...
abstract public class AbstractTracePackageOperation {
    ...
    /**
     * Run the operation. The status (result) of the operation
    ...
    /**
     * Answer a handle to the archive file currently specified as being the source.
     ...
     *
     * @param elements the elements to check for checked
