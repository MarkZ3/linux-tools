...
public class TmfTimestampFormatTest {
    ...
    private final TmfTimestampFormat ts1 = new TmfTimestampFormat("HH:mm:ss.SSS");
//    private final TmfTimestampFormat ts1 = new TmfTimestamp(12345,  0);
//    private final TmfTimestampFormat ts2 = new TmfTimestamp(12345, -1);
//    private final TmfTimestampFormat ts3 = new TmfTimestamp(12345,  2, 5);
